...
export async function main(ns) {
  ...
  */
  ...
  while (targetCurrentMoney < (targetMaxMoney * ((moneyToStealPerBatch * 3) / 100)) && growThread > 3000) {
    // time refresh
    ...
    for (let i = 0; i < ratioWknGrw; i++) {
      if (growThread > 1) {
        ns.exec("grow.js", host, Math.ceil(growThread / 2), target);
